...
const FLOWS = [
  ...
  { id: 4, desc: 'Student Loan Payment', logo: null, from: 'BANK', to: 'LOAN', monthly: '-$1,526.25', yearly: '-$18,314.97', type: 'out', category: 'EDUCATION', note: '$80,000 total · 5.45% · 5yr' },
  { id: 5, desc: 'Apartment Rent', logo: null, from: 'BANK', to: 'LANDLORD', monthly: '-$825.00', yearly: '-$9,900.00', type: 'out', category: 'HOUSING', note: 'Split with 4 roommates' },
  { id: 6, desc: 'Health Insurance', logo: null, from: 'BANK', to: 'POLICY_ME', monthly: '-$150.00', yearly: '-$1,800.00', type: 'out', category: 'HEALTH', note: 'Policy Me' },
  { id: 7, desc: 'Groceries', logo: null, from: 'BANK', to: 'STORES', monthly: '-$425.00', yearly: '-$5,100.00', type: 'out', category: 'GROCERIES', note: 'Remitbee' },
  { id: 8, desc: 'Rogers 2 Gigabit Internet', logo: LOGOS.ROGERS, from: 'BANK', to: 'ROGERS', monthly: '-$95.00', yearly: '-$1,140.00', type: 'out', category: 'INTERNET', note: 'Rogers' },
